...
\gosttitleobject{ГЕНЕРАТОР ПЕРЕЧНЕЙ ''VP\_auto'' (V~3.0)}
\gosttitleobjectI{Генератор перечней ''VP\_auto'' (V~3.0)}

\gosttitledocument{Руководство пользователя}
...
\renewcommand\titlePicture{\AddToShipoutPicture{\AtPageLowerLeft{\includegraphics[width=210mm, height=297mm, viewport=2.0mm 14.0mm 210.0mm 311.0mm]{./VP_auto/background16.jpg}}}}%
